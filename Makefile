...
$(next).xml: $(draft).xml ietf-ssh-client.yang ietf-ssh-server.yang ietf-ssh-common.yang 
	...
	sed -e"s/YYYY-MM-DD/$(shell date +%Y-%m-%d)/" iana-ssh-encryption-algs.yang > iana-ssh-encryption-algs\@$(shell date +%Y-%m-%d).yang
	sed -e"s/YYYY-MM-DD/$(shell date +%Y-%m-%d)/" iana-ssh-key-exchange-algs.yang > iana-ssh-key-exchange-algs\@$(shell date +%Y-%m-%d).yang
	sed -e"s/YYYY-MM-DD/$(shell date +%Y-%m-%d)/" iana-ssh-mac-algs.yang > iana-ssh-mac-algs\@$(shell date +%Y-%m-%d).yang
	sed -e"s/YYYY-MM-DD/$(shell date +%Y-%m-%d)/" iana-ssh-public-key-algs.yang > iana-ssh-public-key-algs\@$(shell date +%Y-%m-%d).yang
